...
import mau.restaurantapp.utils.JSONPathBuilder;
import mau.restaurantapp.utils.LanguageHandler;
import mau.restaurantapp.utils.ListUtil;

import static mau.restaurantapp.R.id.map;

public class FindWay extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rod = inflater.inflate(R.layout.findway, container, false);
    ...
    private void buildDescription(List<String> directions) {
        ...
        ArrayAdapter<String> ap = new ArrayAdapter<>(getActivity(), R.layout.findway_instruction_list, instructions);
