...
import mau.restaurantapp.activities.dialogs.ConfirmDeleteTab;
...
public class MenuListFirebase extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v == removeTab) {
            if (AppData.tabs.size() > 1) {
                d = ConfirmDeleteTab.newInstance(tabKey);
    ...
    public static MenuListFirebase newInstance(int page, String pageTitle, int position, String active, String key) {
        ...
        MenuListFirebase frag = new MenuListFirebase();
    ...
    public boolean isActive() {
        return AppData.stringToBoolean(tabActive);
    }
