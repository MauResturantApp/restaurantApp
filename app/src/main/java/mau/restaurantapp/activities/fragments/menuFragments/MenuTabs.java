...
public class MenuTabs extends Fragment implements OnTabSelectedListener {
    ...
    public class TabsAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return MenuList.newInstance(position + 1, tabs.get(position).getName(), tabs.get(position).getKey());
        }
